 ...
 **完整代码实现位于”AVL_modified.h“ ； "main.cpp"代码提供简单测试**
---
### Part1.思路&一些可行性说明
...
证明平衡能够维持：对任意位置的删除操作，如图，若删除节点在B节点的子树上，删除后h<sub>B</sub>至多 -1。若删除前h<sub>B</sub> >= h<sub>A</sub>,即删除后h<sub>A</sub> - h<sub>B</sub> <= 1。
